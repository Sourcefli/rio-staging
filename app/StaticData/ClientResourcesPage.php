...
class ClientResourcesPage
{
    ...
    public static function bannerData()
    {
        ...
        option([
            "client_resources_banner_heading" => "A “People First” philosophy",
            "client_resources_banner_subheading" => "At American Senior Benefits we are dedicated to serving those in need of insurance, especially seniors. We are proudly independent, answering only to our customers.",
        ]);
    ...
    public static function bannerCtaData()
    {
        ...
        option([
            "client_resources_cta_text" => "",
            "client_resources_cta_link" => "",
        ]);
