<div class="absolute w-full z-20">
    ...
    <nav class="font-sans text-center flex justify-between my-4 mx-auto container overflow-hidden mt-8 z-50 relative px-5">
        <a href="/" class="toggleColour text-gray-700 no-underline hover:no-underline font-bold text-2xl lg:text-3xl mx-auto sm:mx-0">
            <img src="{{ $logo->default_src }}" class="h-24 mt-1" alt="{{ $logo->alt_text }}">
        </a>
