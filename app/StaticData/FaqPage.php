...
class FaqPage
{
    ...
    public static function bannerData()
    {
        ...
        option([
            "faq_banner_heading" => "A “People First” philosophy",
            "faq_banner_subheading" => "At American Senior Benefits we are dedicated to serving those in need of insurance, especially seniors. We are proudly independent, answering only to our customers.",
        ]);
