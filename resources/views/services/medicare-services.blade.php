...
@section('content')
    <div class="col-md-8">
        ...
        <table class="table table-s1 table-claim table-bordered table-vertical">
            ...
            <tr>
                <td>
                    <p><a href="#"><strong>Medicare: Question 1</strong></a><br>
                </td>
                <td>
                    <p>Medicare: answer 1</p>
                </td>
            </tr>
            <tr>
                <td>
                    <p><a href="#"><strong>Medicare: Question 2</strong></a><br>
                </td>
                <td>
                    <p>Medicare: answer 2</p>
                </td>
            </tr>
            </tbody>
        </table>

        <h3>Medicare Options with ASBsw</h3>
        <table class="table table-s1 table-claim table-bordered table-vertical">
            <tbody>
            <tr>
                <td>
                    <p><a href="#"><strong>Medicare: Option 1</strong></a><br>
                </td>
                <td>
                    <p>Medicare: Option 1 description</p>
                </td>
            </tr>
            <tr>
                <td>
                    <p><a href="#"><strong>Medicare: Option 2</strong></a><br>
                </td>
                <td>
                    <p>Medicare: Option 2 description</p>
                </td>
            </tr>
            </tbody>
        </table>
